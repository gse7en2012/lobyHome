...
var config = {
    ...
    vendor: {
        js: [
            ...
            './bower_components/angular-carousel/angular-touch.min.js',
            './bower_components/angular-carousel/angular-carousel.min.js',
...
gulp.task('less', function () {
    return gulp.src(config.less.src).pipe(less({
        ...
        //.pipe(concatCss(config.vendor.css.append[0]))
        .pipe(cssmin())
...
gulp.task('js', function () {
    streamqueue({objectMode: true},
        ...
        gulp.src(['src/templates/**/*.html']).pipe(templateCache({module: 'LobyHome'}))
    )
